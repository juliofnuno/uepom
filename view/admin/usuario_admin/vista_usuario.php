			  ...
			  <table  class=" table table-primary"  >
			  	...
			  	<tr class="success"  align="center">
			  		<td class="success"  >
					      ...
					      <label for="usuario_admin" class="col-sm-9 control-label">USUARIO</label>
					         <div class="col-sm-10">					       
					      <input  type="usuario_admin" class="form-control" id="usuario_admin" name="usuario_admin"  value="<?php echo $row ['usuario_admin'];?>" readonly>
					         </div>
				         </div>
                    </td>	
                     <td>
                       ...
                       <div class="form-group">
					          <label for="pass_admin" class="col-sm-9 control-label">Contraseña</label>
					        <div class="col-sm-10">
						      <input type="pass_admin" class="form-control" id="pass_admin" name="pass_admin"  value="<?php echo $row ['pass_admin'];?>" readonly>
					        </div>
				       </div>                  	
                    </td>
				</tr>
