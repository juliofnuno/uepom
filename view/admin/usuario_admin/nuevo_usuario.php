...
<tr class="success">
    <td>
    	<div class="form-group">
					<label for="usuario_admin" class="col-sm-6 control-label">Nombre del Usuario:</label>
					<div class="col-sm-10">
						<input type="usuario_admin" class="form-control" id="usuario_admin" name="usuario_admin"  required>
					</div>
				</div>
    </td>
    ...
    <td> 
    	<div class="form-group">
					<label for="pass_admin" class="col-sm-3 control-label">Contraseña:</label>
					<div class="col-sm-10">
						<input type="pass_admin" class="form-control" id="pass_admin" name="pass_admin"  required>
					</div>
				</div>
    </td>
<tr>
