...
<tr class="success">
    <td>
    	<div class="form-group">
					<label for="usuario_docente" class="col-sm-6 control-label">Nombre del Usuario:</label>
					<div class="col-sm-10">
						<input type="usuario_docente" class="form-control" id="usuario_docente" name="usuario_docente"  required>
					</div>
				</div>
    </td>
    ...
    <td>
    	<div class="form-group">
					<label for="pass_docente" class="col-sm-3 control-label">Contraseña:</label>
					<div class="col-sm-10">
						<input type="pass_docente" class="form-control" id="pass_docente" name="pass_docente"  required>
					</div>
				</div>
    </td>
<tr>
