			  ...
			  <table  class=" table table-striped"  >
			  	...
			  	<tr class="success"  align="center">
			  		<td class="success"  >
					      ...
					      <label for="usuario_alumno" class="col-sm-9 control-label">USUARIO</label>
					         <div class="col-sm-10">					       
					      <input  type="usuario_alumno" class="form-control" id="usuario_alumno" name="usuario_alumno"  value="<?php echo $row ['usuario_alumno'];?>" readonly>
					         </div>
				         </div>
                    </td>	
                     <td>
                       ...
                       <div class="form-group">
					          <label for="pass_alumno" class="col-sm-9 control-label">Contraseña</label>
					        <div class="col-sm-10">
						      <input type="pass_alumno" class="form-control" id="pass_alumno" name="pass_alumno"  value="<?php echo $row ['pass_alumno'];?>" readonly>
					        </div>
				       </div>                  	
                    </td>
				</tr>
